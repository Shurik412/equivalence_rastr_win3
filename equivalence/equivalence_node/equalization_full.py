...
def equivalent_full_to_nodes(
    ...
    if na != "None":
        ...
        print(f"{na} - {name_area}: count={table_node.Count}, {vyborka}")
            ...
            if tip_node > 1:  # все генераторные узла
                ...
                if j_gen != (-1):
                    ...
                    while j_vetv != (-1):
                        ...
                        if tip_vetv == 1:
                            ...
                            if (v_ip > v_ip_input and v_iq < v_iq_input) or (v_ip < v_ip_input and v_iq > v_iq_input):
                ...
                while j_vetv_2 != (-1):
                    ...
                    if tip_vetv_2 == 1:
                        ...
                        if (v_ip_2 > v_ip_input and v_iq_2 < v_iq_input) or (v_ip_2 < v_ip_input and v_iq_2 > v_iq_input):
                            table_node.Cols(Node.sel).SetZ(j, 0)
